<section class="politicas">
  ...
  <div class="jumbo">
    ...
    <p>Ignilytic te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de
      carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de
      servicios a través del sitio Web <b>www.ignilytic.com</b></p>
  </div>

  <h2>Obtención de datos personales</h2>

  <p>
    Para navegar por <b>www.ignilytic.com</b> no es necesario que facilites ningún dato personal. Los casos en los que
  ...
  <p><b>Finalidad del tratamiento de datos personales</b></p>
  ...
  <p>
    ...
    información puede incluir datos de carácter personal como pueden ser tu dirección IP, nombre y apellidos, dirección
    física, dirección de correo electrónico, número de teléfono, y otra información. Al facilitar esta información, das
  ...
  <p>
    ...
    <b>Formularios de contacto:</b> El Titular solicita datos personales entre los que pueden estar: Nombre y apellidos,
    dirección de correo electrónico, número de teléfono y dirección de tu sitio Web con la finalidad de responder a tus
    consultas.
    <br><br>
    ...
    en el sitio Web, así como cualquier otra consulta que puedas tener y que no esté sujeta a las condiciones del sitio
  ...
  <p>
    ...
    mismos.
    <br> <br>
    El sitio Web está alojado en www.ignilytic.com. La seguridad de tus datos está garantizada, ya que toman todas las
    medidas de seguridad necesarias para ello. Puedes consultar su política de privacidad para tener más información.
  </p>

  <p>Presiona el siguiente boton para regresar</p>
  <a href="inicio" class="boton__ver">Regresar</a>
</section>
